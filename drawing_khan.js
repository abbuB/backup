...
//~
  ...
  buttonS.prototype.clicked=function(){
    if(this.hit){
      ...
      this.parent.ctrls[0].g=this.g;
      this.parent.v=false;
      if(app.debug){ println(this.parent.v); }
    }
  };
...
//~
  ...
  var getQuads=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+240, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getArcs=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+280, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getPolygons=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+320, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getConics=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+360, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getAngles=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+400, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getAnnotations=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+440, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getTransform=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+480, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
  ...
  var getMeasure=function(parent){
    ...
    var cn=new menuH(
            new propC(getGUID(), parent, parent.x, parent.y+520, w+10, w+1, 1, HAND, false, COMMANDS.UNDEF[0], COMMANDS.UNDEF[1]),
            new propL(CLRS.TRANSPARENT, CLRS.Gray7, CLRS.BLACK, CLRS.GRAY, 0.125, 0.25),
            new propA(CLRS.GRAY, CLRS.WHITE, LEFT, CENTER, 10, 11));
